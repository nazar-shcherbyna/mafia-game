...
export const useChangeRoundHook = () => {
  ...
  const {playersStore: previousPlayersStore} = useGetCurrentDayOrNightStore(false)
  ...
  useEffect(() => {
    ...
    if (!playersStore?.[day]) {
      ...
      const previousPlayers = previousPlayersStore[isNight ? day : day-1] || (day===0 && !isNight && playersStore[day]) || {}
